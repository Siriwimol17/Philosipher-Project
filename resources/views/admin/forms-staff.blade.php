                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.storestaff', [Auth::user()->id]) }}" method="post"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="staff_address" style="height: 100px" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" name="staff_tel" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input class="form-control" name="staff_pic" type="file" required>
                                    </div>
                                </div>
                                <div class="row mb-4">
