                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('staff.storeuser', [Auth::user()->id]) }}"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="province" class="form-control" id="input_province" required>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="amphoe" class="form-control" id="input_amphoe" required>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="tambon" class="form-control" id="input_tambon" required>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="input_zipcode" type="address" name="zipcode" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="skill" style="height: 100px" required></textarea>
                                    </div>
                                </div>
                                <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    <label for="validationDefaultPassword" class="col-sm-3 col-form-label" required>อีเมล</label>
                                    <div class="col-sm-6">
